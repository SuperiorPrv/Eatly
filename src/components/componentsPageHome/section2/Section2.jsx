...
const Section3 = () => {
  return (
    <div className="max-w-3xl mx-auto p-8 bg-white rounded-lg  drop-shadow-lg overflow-auto  ">
      ...
      <div className="">
       <ul className="flex flex-wrap gap-[20px] min-w-[709px] items-center justify-between mb-[20px] text-[#606060] text-[16px]"> 
        <li>Support 24/7</li>
        <li><img className="w-[20px]" src="/src/pages/pricing/img/Tick.png" alt="" /></li>
        <li><img className="w-[20px]" src="/src/pages/pricing/img/Tick.png" alt="" /></li>
       </ul>

       <ul className="flex items-center min-w-[709px] justify-between mb-[20px] text-[#606060] text-[16px]"> 
        <li>Fast Delivery</li>
        <li><img className="w-[20px]" src="/src/pages/pricing/img/Tick.png" alt="" /></li>
        <li><img className="w-[20px]" src="/src/pages/pricing/img/Tick.png" alt="" /></li>
       </ul>
      ...
      <div className="flex justify-around min-w-[709px]">
